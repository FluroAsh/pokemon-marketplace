class Card < ApplicationRecord
    ...
    include PgSearch # establish scopes for our searching method
    pg_search_scope :search, against: [:name, :rarity],
        using: {tsearch: {prefix: true, dictionary: "english"}}, # uses en dictionary to distinguish plurals eg: (character vs characters etc), prefix 
